 ...
 * 
 * @author Juan Ocabo
 * Esta clase mostrara las opciones del menu y ejecutara estas, y selecciona el fichero del que se extraera
 * la informacion de la agenda de contactos
 *
 */
public class MenuAgenda {
	...
	//pedira al añadir un contacto añadir (si no existe ya) un telefono automaticamente
