...
public void ImpDisco() {
	System.out.println("titulo: "+gTitulo());
	System.out.println("Numero de canciones: "+gNCanciones());
	System.out.println("Precio: "+gPrecio());
	System.out.println("Fecha: "+gFecha());
}
}